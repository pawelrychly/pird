...
Ostatnia zastosowana miara, okreœla maksymaln¹ korelacjê sygna³u (Kolejnych wartoœci wspó³czynnika cepstralnego), z w³asnym przesuniêciem. Sposób obliczenia tej wartoœci zobrazowano na rysunku \ref{ref-corr}.

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.7\textwidth]{pics/corr.png}
\end{center}
\caption{Rysunek obrazuj¹cy sposób obliczania miary maksymalnej korelacji sygna³u z w³asnym przesuniêciem.}
\label{ref-corr}
\end{figure}

\subsection{Wartoœæ przesuniêcia dla którego uzyskano maksymaln¹ korelacjê}
 Miara okreœla dla jakiego przesuniêcia uzyskano wartoœæ maksymalnej korelacji sygna³u.
...
\subsection{Dodanie atrybutów z wartoœciami przesuniêcia dla którego uzyskano maksymaln¹ korelacjê}
Zbiór testowy równy 10\% ca³ej przestrzeni, zrównowa¿one klasy, Crossvalidacja.
\begin{figure}[H]
\begin{center}
...
\subsection{Usuniêcie z poprzedniego podpunktu miary f\_max}
Zbiór testowy równy 10\% ca³ej przestrzeni, zrównowa¿one klasy, Crossvalidacja.
\begin{figure}[H]
\begin{center}
